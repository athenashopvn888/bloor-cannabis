...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Bloor Cannabis Dispensary is more than just a flower shop. We carry a comprehensive selection of cannabis edibles (gummies, chocolates, baked goods), vape pens and disposable vapes, concentrates (shatter, wax, hash, diamonds, live resin), pre-rolled joints, native cigarettes, rolling papers, and accessories. Our live digital menu at bloorcannabisdispensary.com updates in real time so you always know exactly what's in stock before you make the trip.",
      },
      {
    ...
    faqs: [
      ...
      { q: "What cannabis products does Bloor Cannabis Dispensary carry?", a: "We carry 200+ strains of cannabis flower across 5 quality tiers (Exotic, Premium, AAA+, AA, Budget), plus edibles, vapes, concentrates, pre-rolls, native cigarettes, and accessories. Our menu updates in real time online." },
      { q: "What is the cheapest weed at Bloor Cannabis Dispensary?", a: "Our Budget tier starts at $3/g with value ounces from $40. Our AA tier is $4/g. Every tier includes our 3g bundle pricing, making our prices even more competitive." },
...

  {
    ...
    metaDescription: "Looking for cheap weed in Toronto? Bloor Cannabis Dispensary has budget flower from $3/g, ounces from $40, and 3g bundle pricing. We are Mon-Thu: 11:00 AM - 11:00 PM, Fri-Sat: 11:00 AM - 03:00 AM, Sun: 11:00 AM - 11:00 PM at 993 Bloor St W.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Budget: $3/g — $40/oz. AA: $4/g — $90/oz. AAA+: $5-$6/g — $100/oz. Premium: $7-$10/g. Exotic: $10-$12/g. Every tier includes 3g bundle pricing. Top tiers include 6g bundle pricing. These are some of the lowest prices you'll find at any dispensary in Toronto, 993 Bloor St W & Nearby Expressway and surrounding areas.",
      },
    ],
    faqs: [
    ...
    sections: [
      {
        ...
        body: "Bloor Cannabis Dispensary carries one of the widest selections of native cigarettes in Toronto. Located at 993 Bloor St W near 993 Bloor St W & Nearby Expressway, we stock a comprehensive range of both premium and value native cigarette brands at competitive prices. Whether you prefer full-flavour, light, menthol, or specialty blends, our tobacco selection has something for every smoker. We're proud to be one of the few stores in Toronto that combines a full cannabis dispensary with a comprehensive tobacco counter — one stop for everything you need.",
      },
      {
      ...
      },
      {
        ...
        body: "Our shop at 993 Bloor St W is centrally located in Toronto — easily accessible from Weston Rd, Lawrence Ave W, Highway 401, and all major Peel/Toronto routes. Whether you're walking, driving, or taking the bus, Bloor Cannabis Dispensary is easy to reach. Free evening street parking is available nearby. We serve customers from across Toronto including 993 Bloor St W & Nearby Expressway and surrounding areas.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Bloor Cannabis Dispensary is one of the closest premium cannabis dispensaries to Toronto. Located at 993 Bloor St W in Toronto — just minutes up Highway 410 and East on 401 — we're the easiest dispensary to reach when you're coming from the surrounding area. Whether you're driving from Toronto and surrounding areas, Bloor Cannabis Dispensary is the fastest, most convenient option for top-tier cannabis.",
      },
      {
        heading: "Why Make the Drive to Bloor Cannabis Dispensary?",
        body: "Bloor Cannabis Dispensary offers a wider selection and more competitive pricing than most local Peel options. You'll find over 200 strains across five quality tiers — from ultra-rare Exotic genetics (THC 35-39%) to affordable Budget flower at just $3/g. Our 3g bundle pricing applies to every tier, and our top three tiers offer 6g bundle pricing. With prices starting at $3/g and ounces from $40, Bloor Cannabis Dispensary delivers value that's worth the short drive from Toronto.",
      },
      {
      ...
      },
      {
        ...
        body: "We are located centrally at 993 Bloor St W, Toronto, making it easy to drive or take transit from Toronto. Total drive time is just a few minutes. Free street parking is available.",
      },
      {
        heading: "Full Menu — Cannabis, Edibles, Vapes & More",
        body: "When you make the trip up to Toronto, make it count. Bloor Cannabis Dispensary carries a full selection including 200+ flower strains, edibles, vape pens, disposable vapes, concentrates (shatter, wax, hash, live resin), pre-rolled joints, native cigarettes, and accessories. Check our live online menu at bloorcannabisdispensary.com before you visit to see exactly what's in stock.",
      },
    ],
    faqs: [
      ...
      { q: "Is it worth driving from Mississauga for cannabis?", a: "Absolutely. Bloor Cannabis Dispensary offers 200+ strains, prices starting at $3/g, and bundle pricing options like 3g total that make the short drive incredibly worthwhile." },
      ...
      { q: "What's the cheapest weed near Toronto?", a: "Bloor Cannabis Dispensary has Budget flower from $3/g and value ounces from $40. With our 3g bundle pricing, these are some of the best prices in the Greater Toronto Area." },
    ...
    sections: [
      {
        ...
        body: "If you're searching for a cannabis dispensary near you in Toronto, Bloor Cannabis Dispensary is conveniently located at 993 Bloor St W — in the heart of 993 Bloor St W & Nearby Expressway area. We serve customers from across Toronto, North Toronto, Etobicoke, Mississauga, and Toronto.",
      },
      {
        heading: "Why Choose Bloor Cannabis Dispensary Over Other Dispensaries?",
        body: "What sets Bloor Cannabis Dispensary apart from other Toronto dispensaries is our combination of selection, pricing, and convenience. We carry 200+ strains across five clear quality tiers — no confusing markups, no inconsistent pricing. Our 3g bundle pricing applies to every tier, every purchase. And unlike most dispensaries that close early, we are open Monday to Thursday and Sunday from 11:00 AM to 11:00 PM, and Friday to Saturday from 11:00 AM to 03:00 AM. Whether you need flower, edibles, vapes, or concentrates, Bloor Cannabis Dispensary is here.",
      },
      {
        heading: "Areas We Serve in Greater Toronto Area",
        body: "Bloor Cannabis Dispensary is centrally located and easily accessible from anywhere in Toronto and West Toronto. We regularly serve customers from: 993 Bloor St W & Nearby Expressway and surrounding areas including Toronto, Toronto, and nearby neighbourhoods."
      },
    ],
    faqs: [
