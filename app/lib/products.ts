...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=BCD01`, {
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at Bloor Cannabis Dispensary on Toronto St, Toronto. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in Toronto? Bloor Cannabis Dispensary stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 993 Bloor St W — we are Mon-Thu: 11:00 AM - 11:00 PM, Fri-Sat: 11:00 AM - 03:00 AM, Sun: 11:00 AM - 11:00 PM.",
    faqs: [
      ...
      { q: "Can I buy edibles at Bloor Cannabis Dispensary?", a: "Yes! Visit us at 993 Bloor St W, Toronto. We're open Monday to Thursday and Sunday from 11:00 AM to 11:00 PM, and Friday to Saturday from 11:00 AM to 03:00 AM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at Bloor Cannabis Dispensary, Toronto. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Bloor Cannabis Dispensary carries a curated selection of vape pens and cartridges in Toronto. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 993 Bloor St W for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Bloor Cannabis Dispensary, Toronto. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Bloor Cannabis Dispensary stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 993 Bloor St W, Toronto.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at Bloor Cannabis Dispensary, Toronto. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Bloor Cannabis Dispensary offers a premium selection of cannabis concentrates in Toronto. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 993 Bloor St W.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Bloor Cannabis Dispensary, Toronto. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Bloor Cannabis Dispensary in Toronto. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 993 Bloor St W — we are Mon-Thu: 11:00 AM - 11:00 PM, Fri-Sat: 11:00 AM - 03:00 AM, Sun: 11:00 AM - 11:00 PM.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Bloor Cannabis Dispensary, Toronto. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Bloor Cannabis Dispensary carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 993 Bloor St W, Toronto.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Toronto — Discount Tobacco at Bloor Cannabis Dispensary",
    seoIntro: "Discount native cigarettes at Bloor Cannabis Dispensary, Toronto. Premium and value brands at the best prices on Toronto St.",
    seoDescription: "Bloor Cannabis Dispensary is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 993 Bloor St W in the heart of 993 Bloor St W & Nearby Expressway, we're Mon-Thu: 11:00 AM - 11:00 PM, Fri-Sat: 11:00 AM - 03:00 AM, Sun: 11:00 AM - 11:00 PM.",
    faqs: [
      { q: "Do you sell cigarettes at Bloor Cannabis Dispensary?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the 993 Bloor St W & Nearby Expressway area of Toronto." },
    ],
  },
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Bloor Cannabis Dispensary, Toronto.",
    seoDescription: "Bloor Cannabis Dispensary carries a curated selection of magic mushrooms and specialty products in Toronto. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 993 Bloor St W for our full selection.",
    faqs: [
