...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Nicotine Vapes Toronto | Bloor Cannabis Dispensary",
    seoIntro: "Bloor Cannabis Dispensary keeps nicotine vape products separate from THC Vape products so shoppers can clearly distinguish the two categories. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    seoDescription: "Browse the Bloor Cannabis Dispensary Nicotine Vape category, kept separate from THC Vape products.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "THC Vapes Toronto | Bloor Cannabis Dispensary",
    seoIntro: "Browse the Bloor Cannabis Dispensary THC Vape category, kept separate from Nicotine Vape products.",
    seoDescription: "Explore the THC Vape products presented in this category and check the product details shown while you browse.",
    faqs: [
