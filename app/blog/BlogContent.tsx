...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Bloor Cannabis Dispensary is Toronto's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=BCD01`)
      .then((r) => r.json())
    ...
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          ...
          alt="Bloor Cannabis Dispensary Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Bloor Cannabis Dispensary <span className={styles.heroAccent}>Blog</span>
          </h1>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaSub}>
            200+ strains · Exotic to Budget · Mon-Thu: 11:00 AM - 11:00 PM, Fri-Sat: 11:00 AM - 03:00 AM, Sun: 11:00 AM - 11:00 PM
          </p>
