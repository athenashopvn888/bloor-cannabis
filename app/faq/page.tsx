...
export const metadata: Metadata = {
  title: "FAQ — Bloor Cannabis Dispensary | Toronto Dispensary Questions",
  description:
    "Frequently asked questions about Bloor Cannabis Dispensary in Toronto. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
    canonical: "https://bloorcannabisdispensary.com/faq",
  },
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Bloor Cannabis Dispensary located?", a: "We are located at 993 Bloor St W, Toronto, ON M6H 1M1. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      { q: "What are your hours?", a: "We are open Monday to Thursday and Sunday from 11:00 AM to 11:00 PM, and Friday to Saturday from 11:00 AM to 03:00 AM. Walk in anytime — no appointment needed." },
      ...
      { q: "What's the best way to get to Bloor Cannabis Dispensary?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at bloorcannabisdispensary.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Bloor Cannabis Dispensary is walk-in only. Just show up anytime — we are open Monday to Thursday and Sunday from 11:00 AM to 11:00 PM, and Friday to Saturday from 11:00 AM to 03:00 AM." },
      { q: "Can I order online?", a: "Currently, Bloor Cannabis Dispensary is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="Bloor Cannabis Dispensary FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Bloor Cannabis Dispensary — Toronto&apos;s premium dispensary at 993 Bloor St W in Toronto.
          </p>
