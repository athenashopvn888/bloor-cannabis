...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Bloor Cannabis Dispensary" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="BCD01" />
      <input type="hidden" name="StoreName" value="Bloor Cannabis Dispensary" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Bloor Cannabis Dispensary?</span>
