...
export const metadata: Metadata = {
  title: "Budtender Or Manager Application | Bloor Cannabis Dispensary",
  description:
    "Apply online for budtender or manager opportunities at Bloor Cannabis Dispensary in Toronto. Submit availability, experience, motivation, and customer-service answers.",
  alternates: {
    canonical: "https://www.bloorcannabisdispensary.com/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Bloor Cannabis Dispensary.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Bloor Cannabis Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Bloor Cannabis Dispensary is collecting applications from friendly budtender and manager candidates who communicate clearly, learn the menu, and keep busy shifts organized.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Evening and weekend availability is useful for the Bloor Street schedule</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentGrid}>
          ...
          <section id="application" className={styles.formPanel} aria-label="Budtender application form">
            <div className={styles.formIntro}>
              ...
              <p>
                This form sends your response to the shared hiring intake for Bloor Cannabis Dispensary.
              </p>
